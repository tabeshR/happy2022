...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">عضویت در اپ</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">تکرار کلمه عبور</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                               <x-recaptcha :key="env('RECAPTCHA_SITE_KEY')" />
                            </div>
                        </div>
